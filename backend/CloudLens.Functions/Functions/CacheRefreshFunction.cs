...
public class CacheRefreshFunction
{
    ...
    private async Task RefreshResourcesAsync(AzureCredentials credentials)
    {
        try
        {
            ...
            {
                _dbContext.CachedResources.Add(new CloudLens.API.Data.Entities.CachedResource
                {
    ...
    private async Task RefreshCostsAsync(AzureCredentials credentials)
    {
        try
        {
            ...
            {
                _dbContext.CachedCosts.Add(new CloudLens.API.Data.Entities.CachedCost
                {
    ...
    private async Task RefreshResourceCostsAsync(AzureCredentials credentials)
    {
        try
        {
            ...
            {
                _dbContext.CachedResourceCosts.Add(new CloudLens.API.Data.Entities.CachedResourceCost
                {
            ...
            var monthlyCostsByMonth = resourceCosts
                ...
                .GroupBy(m => m.Month)
                .Select(g => new CloudLens.API.Models.MonthlyCost
                {
                    Month = g.Key,
                    Cost = g.Sum(m => m.Cost),
            ...
            if (monthlyCostsByMonth.Any())
            {
                ...
                {
                    _dbContext.CachedMonthlyCosts.Add(new CloudLens.API.Data.Entities.CachedMonthlyCost
                    {
